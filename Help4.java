 ...
 * @author Kevin LA
 */
public class Help4 extends StaticBody  implements SensorListener{
    
    private static final BodyImage helpImage = new BodyImage("data/Help.png",2);  
     private static final BodyImage helpTextImage = new BodyImage("data/Help4.png",8);  
  
    private Strider ninja;
    /**
     * Constructor that initialises instances of Help4
     * @param world the world
     * @param ninja the player character
     */
    public Help4(World world, Strider ninja) {
        super(world);
        this.ninja=ninja;
    ...
    /**
     * Method for when Player character enters Help4
     * Sensor
     * @param e the sensor
     */
    @Override
    ...
    /**
     * Method for when Player character leaves Help4
     * Sensor
     * @param e the sensor
     */
    @Override
